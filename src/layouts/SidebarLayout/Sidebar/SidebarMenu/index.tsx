        ...
        >
          <SubMenuWrapper>
            <List component="div">
              ...
              <ListItem component="div">
                <NextLink href="/recursos-multimedia" passHref>
                  <Button
                    className={
                      currentRoute === '/recursos-multimedia' ? 'active' : ''
                    }
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
              ...
              <ListItem component="div">
                <NextLink href="/pagina-principal" passHref>
                  <Button
                    className={
                      currentRoute === '/pagina-principal' ? 'active' : ''
                    }
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
        ...
        >
          <SubMenuWrapper>
            <List component="div">
              ...
              <ListItem component="div">
                <NextLink href="/recursos-multimedia-noticias" passHref>
                  <Button
                    className={
                      currentRoute === '/recursos-multimedia-noticias' ? 'active' : ''
                    }
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
